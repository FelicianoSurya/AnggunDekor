...
<div class="container w-100 d-flex flex-column align-items-center">
    ...
    <form method="POST" class="w-50" action="{{ url('/admin/portfolioType/add') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group row flex-column">
            ...
            <div class="col-md-12 m-0 row flex-column img-invalid">
                <input type="file" placeholder="Portotype Type Imge" id="image" name="image" class="form-control @error('image') is-invalid @enderror" name="email" value="{{ old('image') }}" />
